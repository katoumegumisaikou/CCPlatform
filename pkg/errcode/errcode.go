...
var (
	...
	ErrGeofenceNotFound     = New(10020, "电子围栏不存在", http.StatusNotFound)
	ErrGeofenceConflict     = New(10021, "围栏坐标或参数无效", http.StatusBadRequest)
	ErrPredictionNotFound   = New(10022, "预测记录不存在", http.StatusNotFound)
)
